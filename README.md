# AWSPrepAI
AWS Certification study tool with 287+ practice questions for Cloud Practitioner (CLF-C02) and Solutions Architect Associate (SAA-C03)
...
| Feature | Description |
|---------|-------------|
| **Dual Certifications** | Support for CLF-C02 (38 questions) and SAA-C03 (249 questions from multiple practice tests) |
| **Practice Quiz** | 287+ total questions across all AWS domains with detailed explanations |
...
### 🏗️ AWS Solutions Architect Associate (SAA-C03) - 249 Questions
...
- Design Cost-Optimized Architectures - Storage classes, compute options, cost monitoring, S3 lifecycle
...
1. Visit [https://isaloum.github.io/AWSPrepAI](https://isaloum.github.io/AWSPrepAI)
2. Start with the **Practice Quiz** to assess your knowledge
3. Use **Flashcards** to memorize AWS services
4. Take a **Mock Exam** when you're ready
5. Focus on your **Weak Areas** shown in the dashboard
...
**Ihab Saloum** - [GitHub](https://github.com/Isaloum)
