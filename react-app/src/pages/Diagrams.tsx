...
const DIAGRAMS: Diagram[] = [
  ...
  // ── Cost Optimized ────────────────────────────────────────────────────────
  {
    ...
    nodes: [
      { id: 'std',      label: 'S3 Standard\n0+ days',             x: 150, y: 110, color: '#1A73E8' },
      { id: 'int-tier', label: 'Intelligent\nTiering',             x: 150, y: 320, color: '#0891b2' },
      { id: 'std-ia',   label: 'S3 Standard-IA\nafter 30 days',    x: 450, y: 110, color: '#16a34a' },
      { id: 'one-zone', label: 'One Zone-IA\nSingle AZ',           x: 450, y: 320, color: '#ca8a04' },
      { id: 'gl-inst',  label: 'Glacier Instant\nafter 90 days',   x: 750, y: 110, color: '#7C3AED' },
      { id: 'gl-flex',  label: 'Glacier Flexible\nafter 180 days', x: 750, y: 320, color: '#475569' },
      { id: 'deep',     label: 'Glacier Deep\nArchive\n365+ days', x: 750, y: 530, color: '#374151' },
    ],
    edges: [
      { from: 'std',      to: 'std-ia' },
