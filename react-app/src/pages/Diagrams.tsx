...
const DIAGRAMS: Diagram[] = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'br',    label: 'Backup &\nRestore', x: 90,  y: 210, color: '#9ca3af' },
      { id: 'pl',    label: 'Pilot\nLight',      x: 280, y: 210, color: '#475569' },
      { id: 'ws',    label: 'Warm\nStandby',     x: 470, y: 210, color: '#2563eb' },
      { id: 'aa',    label: 'Active-\nActive',   x: 660, y: 210, color: '#16a34a' },
      { id: 'cost',  label: 'Cost ↑',            x: 90,  y: 360, color: '#dc2626' },
    ],
    edges: [
      { from: 'speed', to: 'aa',  label: 'fastest recovery', labelFlip: true },
      { from: 'br',    to: 'pl' },
      { from: 'pl',    to: 'ws' },
      { from: 'ws',    to: 'aa' },
      { from: 'cost',  to: 'aa',  label: 'most expensive' },
    ],
  },
