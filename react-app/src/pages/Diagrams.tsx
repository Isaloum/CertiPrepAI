...
const DIAGRAMS: Diagram[] = [
  ...
  // ── Cost Optimized ────────────────────────────────────────────────────────
  {
    ...
    nodes: [
      { id: 'std',      label: 'S3 Standard\n0+ days',             x: 100,  y: 130, color: '#1A73E8' },
      { id: 'std-ia',   label: 'S3 Standard-IA\nafter 30 days',    x: 380,  y: 130, color: '#16a34a' },
      { id: 'gl-inst',  label: 'Glacier Instant\nafter 90 days',   x: 660,  y: 130, color: '#7C3AED' },
      { id: 'gl-flex',  label: 'Glacier Flexible\nafter 180 days', x: 940,  y: 130, color: '#475569' },
      { id: 'deep',     label: 'Glacier Deep\nArchive\n365+ days', x: 1220, y: 130, color: '#374151' },
      { id: 'int-tier', label: 'Intelligent\nTiering',             x: 240,  y: 340, color: '#0891b2' },
      { id: 'one-zone', label: 'One Zone-IA\nSingle AZ',           x: 520,  y: 340, color: '#ca8a04' },
    ],
    edges: [
      { from: 'std',     to: 'std-ia' },
      ...
      { from: 'std',     to: 'int-tier', label: 'auto-tiering', dashed: true },
      { from: 'std-ia',  to: 'one-zone', label: 'single AZ opt', dashed: true },
    ],
  },
  {
    id: 'ec2-pricing',
