    ...
    <Layout>
      <div style={{ maxWidth: '520px', margin: '4rem auto', padding: '0 1rem', textAlign: 'center' }}>
        ...
        <p style={{ color: '#6b7280', marginBottom: '2rem', lineHeight: 1.7 }}>
          Your account has been upgraded. You now have full access to all 3,910 questions across 12 AWS certifications.
        </p>

        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem', marginBottom: '2rem' }}>
          {[
            { icon: '✅', label: '3,910 Questions', sub: 'All 12 certs' },
