...
export default function About() {
  ...
  const faqs = [
    ...
    { q: 'How do explanations work?', a: 'Every question includes a detailed explanation of why the correct answer is right and why the others are wrong — written in plain English, not AWS jargon.' },
  ]

  const features = [
    { icon: '📝', title: '3,910 Questions', desc: '260 per cert across all 12 AWS certifications, updated regularly', color: '#eff6ff', border: '#bfdbfe' },
  ...
  const stats = [
    { value: '3,910', label: 'Practice Questions' },
