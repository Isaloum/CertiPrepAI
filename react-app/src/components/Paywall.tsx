  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-2xl" onClick={e => e.stopPropagation()}>
        ...
        <p className="text-gray-500 mb-4">You've used your 50 free questions. Upgrade to keep practicing.</p>
        ...
        <button onClick={onClose} className="text-sm text-gray-400 hover:text-gray-600">Continue with free (50 questions)</button>
      </div>
    </div>
  )
}
